...
public class MainActivity extends Activity implements OnClickListener {
    ...
    public void onClick(View target) {
        ...
        if (target == mPlayButton) {
            Intent intent = new Intent(this, MusicService.class);//; new Intent(MusicService.ACTION_PLAY)
            intent.putExtra(MusicService.ACTION, MusicService.ACTION_PLAY);
            startService(intent);
        } else if (target == mPauseButton) {
            Intent intent = new Intent(this, MusicService.class);//; new Intent(MusicService.ACTION_PAUSE)
            intent.putExtra(MusicService.ACTION, MusicService.ACTION_PAUSE);
            startService(intent);
        } else if (target == mSkipButton) {
            Intent intent = new Intent(this, MusicService.class);//; new Intent(MusicService.ACTION_SKIP)
            intent.putExtra(MusicService.ACTION, MusicService.ACTION_SKIP);
            startService(intent);
        } else if (target == mRewindButton) {
            Intent intent = new Intent(this, MusicService.class);//; new Intent(MusicService.ACTION_REWIND)
            intent.putExtra(MusicService.ACTION, MusicService.ACTION_REWIND);
            startService(intent);
        } else if (target == mStopButton) {
            Intent intent = new Intent(this, MusicService.class);//; new Intent(MusicService.ACTION_STOP)
            intent.putExtra(MusicService.ACTION, MusicService.ACTION_STOP);
            startService(intent);
